...
public class ShowMyAppointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_my_appointment);
...
//                Intent i = new Intent(ShowMyAppointment.this, feedback.class);
